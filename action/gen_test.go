...
func TestGenDB(t *testing.T) {
	...
	gOpts.ChartsParentDir = base.CompletePath("../", "")
	gOpts.ChartName = "iter8"
	gOpts.Values = []string{"tasks={custommetrics,assess}", "custommetrics.providerURLs[0]=https://raw.githubusercontent.com/iter8-tools/iter8/master/charts/iter8lib/templates/_metrics-istio.tpl", "custommetrics.common.providerURL=http://prometheus.istio-system:9090/api/v1/query", "custommetrics.versionValues[0].destination_workload=httpbin-v2", "custommetrics.versionValues[0].destination_workload_namespace=default", `custommetrics.versionValues[0].startingTime="2020-02-01T09:44:40Z"`, "assess.SLOs.upper.istio/error-rate=0"}
