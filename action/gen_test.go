...
func TestGenDB(t *testing.T) {
	...
	gOpts.Values = []string{"providerURL=http://prometheus.istio-system:9090/api/v1/query", "destination_workload=httpbin-v2", "destination_workload_namespace=default", `startingTime="2020-02-01T09:44:40Z"`, "istio/error-rate=0"}
