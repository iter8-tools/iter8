...
// Test read of application stored in cluster
...
func setup(t *testing.T) *ApplicationReaderWriter {
	...
	YamlToSecret("../../testdata", "abninputs/readtest.yaml", "default", "application", k8sdriver.Driver)
	return &ApplicationReaderWriter{Client: k8sdriver.Driver.Clientset}
}
