...
**Note:** This build step is usually required only for the first time you work with iter8 docs locally.

**Pre-requisite:** [Node.js 12+](https://nodejs.org/en/)

Fork the iter8 repo, clone your fork, and npm.
...
Browse http://localhost:8000 for your local iter8 docs.
