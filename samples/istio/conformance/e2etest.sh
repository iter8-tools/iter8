...
sed "s+URL_VALUE+${URL_VALUE}+g" $ITER8/samples/istio/conformance/fortio.yaml | sed "s/6000s/120s/g" | kubectl apply -f -
...
# Check
source $ITER8/samples/istio/conformance/check.sh
