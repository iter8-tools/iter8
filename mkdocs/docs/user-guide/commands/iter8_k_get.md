...
Get a list of experiments running in the current context
...
```
  -e, --experiment-id string   remote experiment identifier
  -h, --help                   help for get
```
...
* [iter8 k get options](iter8_k_get_options.md)	 - Print the list of flags inherited by all commands
