...
!!! tip "Scenario: Iter8+Gitops"
    ...
    We assume the reader has at least a basic understanding of how Iter8 works from the [quick start tutorial](../../../getting-started/quick-start/istio/platform-setup.md#1-create-kubernetes-cluster). Since the Env repo is at the heart of GitOps, we will focus mainly on how to setup and manage the Env repo during application updates. In this tutorial, we will cover the following topics.
