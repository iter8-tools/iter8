...
Currently the iter8 extension for Kiali (v1.24) works only for [iter8 v1.0.0-rc3](https://iter8.tools/) and above. To install on either Kubernetes or OpenShift, please see [here](https://iter8.tools/installation/).
