...
All Kubernetes YAML files you will need in this tutorial are in the _iter8-controller_ repository [here](https://github.com/iter8-tools/iter8-controller/tree/v0.1.1/doc/tutorials/istio/bookinfo). 

## Part 1: Successful canary release: _reviews-v2_ to _reviews-v3_

### 1. Deploy the Bookinfo application

At this point, we assume that you have already followed the [instructions](https://github.com/iter8-tools/docs/blob/v0.1.1/doc_files/iter8_install.md) to install _iter8_ on your Kubernetes cluster. The next step is to deploy the sample application we will use for the tutorial.
...
```bash
kubectl apply -n bookinfo-iter8 -f https://raw.githubusercontent.com/iter8-tools/iter8-controller/v0.1.1/doc/tutorials/istio/bookinfo/bookinfo-gateway.yaml
```
...
```bash
kubectl apply -n bookinfo-iter8 -f https://raw.githubusercontent.com/iter8-tools/iter8-controller/v0.1.1/doc/tutorials/istio/bookinfo/canary_reviews-v2_to_reviews-v3_telemetry-v2.yaml
```
...
```bash
kubectl apply -n bookinfo-iter8 -f https://raw.githubusercontent.com/iter8-tools/iter8-controller/0.1.1/doc/tutorials/istio/bookinfo/canary_reviews-v3_to_reviews-v4_telemetry-v2.yaml
```
...
```bash
kubectl apply -n bookinfo-iter8 -f https://raw.githubusercontent.com/iter8-tools/iter8-controller/0.1.1/doc/tutorials/istio/bookinfo/canary_reviews-v3_to_reviews-v5_telemetry-v2.yaml
```
...
```bash
kubectl apply -n iter8 -f https://raw.githubusercontent.com/iter8-tools/iter8-controller/0.1.1/doc/tutorials/istio/bookinfo/iter8_metrics_extended_telemetry-v2.yaml
```
...
```bash
kubectl apply -n bookinfo-iter8 -f https://raw.githubusercontent.com/iter8-tools/iter8-controller/0.1.1/doc/tutorials/istio/bookinfo/canary_reviews-v3_to_reviews-v6_telemetry-v6.yaml
```
...
```bash
kubectl apply -n bookinfo-iter8 -f https://raw.githubusercontent.com/iter8-tools/iter8-controller/0.1.1/doc/tutorials/istio/bookinfo/canary_productpage-v1_to_productpage-v2_telemetry-v2.yaml
```
